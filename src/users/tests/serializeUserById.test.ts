...
import { serializeUserById } from "../middleware";
...
describe("serializeUserById Middleware", () => {
  ...
  it("should send user data for a valid ID", async () => {
    const mockUser = {
      id: "123",
    ...
    await serializeUserById(req, res, mockNext);
